			...
			<div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
				<div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-3 xl:gap-8 lg:space-y-0">
					...
					<div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
						<h3 className="mb-4 text-2xl font-semibold">Premium petcare+</h3>
						...
						<ul role="list" className="mb-8 space-y-4 text-left">
							...
							<li className="flex items-center space-x-3">
								...
								<span>
									Videollamadas gratuitas con veterinarios, en cualquier momento
									que necesite.
								</span>
							</li>
							<li className="flex items-center space-x-3">
							...
							<li className="flex items-center space-x-3">
								...
								<span>Mejora tu listado en los resultados de búsqueda</span>
							</li>
							<li className="flex items-center space-x-3">
								{/* Icon */}
								<svg
					...
					<div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-orange-50 rounded-lg border border-gray-300 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
						<h3 className="mb-4 text-2xl font-semibold">Standar petcare+</h3>
						<p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
					...
					{/* Pricing Card */}
					<div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
						<h3 className="mb-4 text-2xl font-semibold">Basic petcare+</h3>
						<p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
